...
const LandingPage = () => {
	...
	return (
		...
		<header className="container mx-auto px-4 py-16 text-center">
			...
			<Link 
				to={authUser? ("/match"):("/auth")} className="bg-rose-400 text-white px-8 py-4 rounded-full text-lg hover:bg-rose-600 transition">
				{t("landing.start_btn")}
			</Link>
		</header>
		...
		<section className="bg-rose-50 py-16">
			...
			<Link 
				to="/auth"
			className="bg-rose-400 text-white px-8 py-4 rounded-full text-lg hover:bg-rose-600 transition">
				{t("landing.free_reg")}
			</Link>
			</div>
		</section>
